<script setup>
import { toRaw, ref, onMounted, watch, defineProps } from "vue";
...
const markerPositions = ref(props.positions);

console.log("positions", markerPositions.value);

watch(markerPositions.value, (newValue, oldValue) => {
  console.log("watch", newValue);
  displayMarker(newValue);
});
